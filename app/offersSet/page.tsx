              ...
              >
                ...
                <div className="relative aspect-video w-full overflow-hidden">
                  ...
                  {offer.badge && (
                    <div className="absolute top-3 right-3">
                      <span className="px-2 py-1 bg-primary text-primary-foreground text-[8px] font-black uppercase tracking-widest rounded-full shadow-lg">
                        {offer.badge}
                      </span>
                    </div>
                  )}
                ...
                <div className="p-4 flex-1 flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-black text-foreground truncate group-hover:text-primary transition-colors italic">
                      {offer.title}
                    </h3>
                    <span className="text-xs font-black text-primary">
                      {offer.price} <span className="text-[10px]">جنية</span>
                    </span>
                  </div>
